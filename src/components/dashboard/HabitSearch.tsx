...
//   mutatedData: string[];
//   setMutatedData: (data: any) => void;
// }

// const HabitSearch: React.FC<HabitProps> = ({ mutatedData, setMutatedData }) => {
...
//                     !mutatedData.includes(option) ? "bg-white" : "bg-black"
//                   } ${
