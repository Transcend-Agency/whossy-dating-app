...
const EditProfile: React.FC<EditProfileProps> = ({ activePage, closePage, onPreviewProfile, userData, userPrefencesData, refetchUserData, refetchUserPreferencesData }) => {
    ...
    return (
        <>
            ...
            <HeightSettingsModal showing={settingsModalShowing === 'height'} hideModal={hideModal} userHeight={userPrefencesData?.height ? userPrefencesData?.height as number : 0}  handleSave={(height) => updateUserPreferences({height}) }/>
            <WeightSettingsModal showing={settingsModalShowing === 'weight'} hideModal={hideModal} userWeight={userPrefencesData?.weight ? userPrefencesData?.weight as number : 0}  handleSave={(weight) => updateUserPreferences({weight}) }/>
