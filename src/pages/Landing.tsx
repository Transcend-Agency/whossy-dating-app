            ...
            <div className='block lg:hidden'>
                <div className="h-[90dvh] relative top-[10dvh] aspect-[0.49] px-[5rem]">
                    <div className="flex flex-col items-center justify-center bg-white">
                        ...
                        <p className="text-gray text-[1.4rem] leading-[1.68rem] text-center px-6 mt-4">
                        ...
                        <div className="mt-3">
                            <img
                                src="/assets/images/website/match.png"
                                alt="Matched Profile"
                                className=""
                            />
                        </div>
   ...
   {/* MOBILE */}
    <section className="block lg:hidden relative w-full py-[12.8rem] space-y-[8rem]">
        ...
        <div className="text-center space-y-[2.4rem]">
            <div className=" right-[2rem] bottom-[16rem] gap-y-[3.2rem] ">
                <p className="text-[3rem] leading-[3rem]">STEPHANIE & DAVID</p>
                <p className="text-[2rem] leading-[1.68rem] text-gray">
    ...
    <section className="hidden lg:block relative py-[12.8rem] w-full bg-white space-y-[4rem] ">
          ...
          <div className="lg:grid lg:grid-cols-3">
            <div className="flex items-end justify-start pl-[3.2rem] space-x-[5rem]">
                <button><img src={'/assets/icons/ArrowLeft.svg'} alt="left arrow" /></button>
                <button><img src={'/assets/icons/ArrowRight.svg'} alt="right arrow" /></button>
            </div>
            ...
            <div className="w-4/5 flex items-end ">
                <div>
                    <p className="text-[3.2rem] leading-[3.84rem]">STEPHANIE & DAVID</p>
                    <p className="text-gray text-[1.8rem] leading-[2.16rem]">
                      He was my first thought when I woke up in the morning.
                    </p>
                </div>
            </div>
