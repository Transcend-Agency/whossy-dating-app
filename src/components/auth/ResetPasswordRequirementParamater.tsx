...
const ResetPasswordRequirementParamater: React.FC<ResetPasswordRequirementParamaterProps> = ({ text, criteriaPassed }) => {
    ...
    return <div className='reset-password__password-requirements__parameter'>
        <svg width="11" height="8" viewBox="0 0 11 8" className={`reset-password__password-requirements__parameter__icon ${!criteriaPassed && 'reset-password__password-requirements__parameter__icon--inactive'}`} xmlns="http://www.w3.org/2000/svg">
        ...
        <span className={`reset-password__password-requirements__parameter__text  ${!criteriaPassed && 'reset-password__password-requirements__parameter__text--inactive'}`}>{text}</span>
    </div>
}
